...
class CSl_position
{
  ...
  {
    return '/component/sl_position/resources/';
  }
  ...
  protected function &_getModel()
  {
    ...
    require_once('component/sl_position/sl_position.model.php5');
    require_once('component/sl_position/sl_position.model.ex.php5');
    $this->coModel = new CSl_positionModelEx();
