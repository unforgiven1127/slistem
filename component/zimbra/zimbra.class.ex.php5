...
class CZimbraEx extends CZimbra
{
   ...
   */
   ...
   {
      echo '<fieldset><legend>Zimbra cron options:</legend> &refreshShared=1  to refresh Global shared calendar (&wipeOnly=1 to simply clean shared)<br />
        &refreshBcm=1  to refresh the local database events <br/>
        &refreshShared=1&refreshBcm=1 for both</fieldset>';
    ...
    */
    ...
    protected function getUserAuthenticate()
    {
      ...
      //curl_setopt($this->coCurl, CURLOPT_SSLVERSION, 3);
