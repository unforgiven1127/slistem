...
class CField
{
  ...
  protected $casFieldControls = array('jsFieldJpPostCode', 'jsFieldNotEmpty', 'jsFieldMinSize', 'jsFieldMaxSize', 'jsFieldMinValue', 'jsFieldMaxValue', 'jsFieldTypeInteger', 'jsFieldDate', 'jsFieldTypeIntegerPositive', 'jsFieldTypeIntegerNegative', 'jsFieldTypeFloat', 'jsFieldTypeCurrency', 'jsFieldTypeEmail', 'jsFieldGreaterThan', 'jsFieldSmallerThan', 'jsFieldTypeUrl', 'jsFieldTypeCurrencyJpy', 'jsFieldTypeCurrencyEu');
  protected $csFieldRequired = 'jsFieldNotEmpty';
