...
class CMisc extends CField
{
  ...
  public function getDisplay()
  {
    ...
    $bCloseDiv = false;
    if(isset($this->casFieldParams['label']) && !empty($this->casFieldParams['label']))
    {
      $sHTML.= '<div class="formLabel">'.$this->casFieldParams['label'].'</div><div class="formField">';
      $bCloseDiv = true;
    }
    ...
    switch($sFieldType)
    {
      ...
      case 'text':
        ...
        set_array($this->casFieldParams['class'], ' formFieldTitle',' formFieldTitle');
