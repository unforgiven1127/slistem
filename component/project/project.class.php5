...
class CProject
{
  ...
  {
    return '/component/project/resources/';
  }
  ...
  protected function &_getModel()
  {
    ...
    require_once('component/project/project.model.php5');
    require_once('component/project/project.model.ex.php5');
    $this->coModel = new CProjectModelEx();
