...
class CSettings
{
  ...
  protected function &_getModel()
  {
    ...
    require_once('component/settings/settings.model.php5');
    require_once('component/settings/settings.model.ex.php5');
    $this->coModel = new CSettingsModelEx();
