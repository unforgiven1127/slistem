...
class CManageablelist
{
  protected $csUid = '134-685';
  protected $csAction = '';
  protected $csType = '';
  protected $cnPk = 0;
  protected $csMode = '';
  ...
  {
    return '/component/manageablelist/resources/';
  }
  ...
  protected function &_getModel()
  {
    ...
    require_once('component/manageablelist/manageablelist.model.php5');
    require_once('component/manageablelist/manageablelist.model.ex.php5');
    $this->coModel = new CManageablelistModelEx();
