...
class CGbUser
{
  ...
  {
    return '/component/globus/gb_user/resources/';
  }
  ...
  protected function &_getModel()
  {
    ...
    require_once('component/globus/gb_user/gb_user.model.php5');
    require_once('component/globus/gb_user/gb_user.model.ex.php5');
    $this->coModel = new CGbUserModelEx();
